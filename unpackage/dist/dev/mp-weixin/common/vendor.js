...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/tabbar/home/home": { "navigationBarTitleText": "首页" }, "pages/auth/auth": { "navigationBarTitleText": "授权" }, "pages/todoDetail/todoDetail": { "navigationBarTitleText": "定制详情" }, "pages/writeOrder/writeOrder": { "navigationBarTitleText": "填写订单" }, "pages/preview/preview": { "navigationBarTitleText": "预览设计" }, "pages/tabbar/todo/todo": { "navigationBarTitleText": "个性定制" }, "pages/addressDetail/addressDetail": { "navigationBarTitleText": "操作地址" }, "pages/refundOrder/refundOrder": { "navigationBarTitleText": "退款维权" }, "pages/orderList/orderList": { "navigationBarTitleText": "订单列表" }, "pages/tabbar/mine/mine": { "navigationBarTitleText": "个人中心" }, "pages/addressIndex/addressIndex": { "navigationBarTitleText": "地址列表" }, "pages/orderStatus/orderStatus": { "navigationBarTitleText": "订单状态" }, "pages/selectType/selectType": { "navigationBarTitleText": "选择属性" } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "GXG", "navigationBarBackgroundColor": "#F8F8F8", "backgroundColor": "#F8F8F8" } };exports.default = _default;
...
var _api = __webpack_require__(/*! @/config/api.js */ 19);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var _require = __webpack_require__(/*! ../utils/storage.js */ 16),setStorage = _require.setStorage,getStorage = _require.getStorage;var _require2 = __webpack_require__(/*! ./router.js */ 17),AUTH = _require2.AUTH;

var loading = {
  inLoading: false,
  showLoadind: function showLoadind(loadingText) {var _this = this;
  ...
  hideLoading: function hideLoading() {var _this2 = this;
...
/**
   ...
   */
var inRefreshToken = false;
var refreshToken = /*#__PURE__*/function () {var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var isLogin, refreshToken, res;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:if (!(
            inRefreshToken === true)) {_context2.next = 2;break;}return _context2.abrupt("return");case 2:
            inRefreshToken = true;
            isLogin = getStorage('isLogin');if (
            isLogin) {_context2.next = 6;break;}return _context2.abrupt("return");case 6:
            refreshToken = getStorage('refreshToken');_context2.next = 9;return (
              request({
                method: 'POST',
                url: "".concat(_api.LOGIN_TOKEN_REFRESH, "?refreshToken=").concat(refreshToken),
                needToken: false,
                showLoading: false,
                hideLoading: false,
...
module.exports = {
  ...
  LOGIN_WECHAT_GET_PHONENUM: "".concat(auth, "/getPhoneNumber"),
  LOGIN_APP_REGISTER_LOGIN: "".concat(auth, "/register"),
  LOGIN_TOKEN_REFRESH: "".concat(auth, "/refresh"),
  LOGIN_OPENID_REFRESH: "".concat(auth, "/refreshOpenId"),

  /** ---------------------- 首页 ---------------------- **/

  // 获取主题
  GET_THEME: "".concat(baseUrl, "/index/queryIndex"),
  // 获取品类列表
  GET_CATEGORY: "".concat(baseUrl, "/index/queryCategory"),
  // 加载样式列表
  GET_STYLE_LIST: "".concat(baseUrl, "/index/LoadIndex"),

  /** ---------------------- 个性定制 ---------------------- **/

  // 通过品类获取版型
  GET_RELEASE_BY_CATEGORY: "".concat(baseUrl, "/cust/loadVersionByCategoryId"),

  /** ---------------------- 选择属性 ---------------------- **/

  // 获取版型详情
  GET_RELEASE_DETAIL: "".concat(baseUrl, "/cust/LoadModelByVersionId"),
  // 通过版型颜色尺码性别获取商品信息
  GET_PRODUCT_BY_RELEASEID_COLOR_SIZE_SEX: "".concat(baseUrl, "/cust/LoadModelInfoByVersionId"),
  // 获取商品图片
  GET_PRODUCT_IMG_BY_RELEASEID_COLOR_SIZE_SEX: "".concat(baseUrl, "/cust/LoadModelImgByVersionId"),
  // 获取商品尺寸
  GET_PRODUCT_SIZE: "".concat(baseUrl, "/cust/getGoodsSize"),

  /** ---------------------- 开始定制 ---------------------- **/

  // 加载元素
  LOAD_ELEMENT: "".concat(baseUrl, "/cust/loadElement"),
  // 获取系列列表
  GET_SERIES: "".concat(baseUrl, "/cust/loadSeries"),
  // 获取图案列表
  GET_PATTERN: "".concat(baseUrl, "/cust/loadPrinting"),
  // 获取商品图片列表
  GET_PRODUCT_IMG: "".concat(baseUrl, "/cust/LoadModelImgByGoodsId"),
  // 获取商品详情
  GET_MODEL: "".concat(baseUrl, "/wxorder/queryModel"),
  // 获取字体颜色列表
  GET_FONT_COLOR: "".concat(baseUrl, "/cust/loadColor"),
  // 获取字体类型列表
  GET_FONT_FAMILY: "".concat(baseUrl, "/cust/loadFont"),
  // 获取字体大小列表
  GET_FONT_SIZE: "".concat(baseUrl, "/cust/loadSize"),
  // 保持设计
  SAVE_DESIGN: "".concat(baseUrl, "/cust/SaveQreview"),

  /** ---------------------- 预览设计 ---------------------- **/

  // 创建订单
  CREATE_ORDER: "".concat(baseUrl, "/wxorder/createOrder"),

  /** ---------------------- 填写订单 ---------------------- **/

  // 获取物流信息
  GET_LOGISTICS: "".concat(baseUrl, "/wxorder/getLogistics"),
  // 获取收货地址
  GET_RECEIVE: "".concat(baseUrl, "/wxorder/LoadReceive"),
  // 提交订单
  SUBMIT_ORDER: "".concat(baseUrl, "/wxorder/subOrder"),
  // 统一下单
  UNIFIED_ORDER: "".concat(baseUrl, "/payment/toPay"),
  // 支付成功
  PAY_SUCCESS: "".concat(baseUrl, "/wxorder/OrderPay"),

  /** ---------------------- 订单状态 ---------------------- **/

  // 获取订单详情
  GET_ORDER_DETAIL: "".concat(baseUrl, "/wxorder/queryOrderDetails"),
  // 获取订单按钮
  GET_ORDER_BUTTON: "".concat(baseUrl, "/wxorder/Loadbutton"),
  // 删除订单
  DELETE_ORDER: "".concat(baseUrl, "/wxorder/deleteOrder"),
  //确认收货
  ORDER_DELIVERY: "".concat(baseUrl, "/wxorder/OrderDelivery"),

  /** ---------------------- 操作地址 ---------------------- **/

  // 添加收货地址
  ADD_RECEIVE_ADDRESS: "".concat(baseUrl, "/wxorder/addReceive"),
  // 删除收货地址
  DELETE_RECEIVE_ADDRESS: "".concat(baseUrl, "/wxorder/deleteReceive"),
  // 更新收货地址
  UPDATE_RECEIVE_ADDRESS: "".concat(baseUrl, "/wxorder/updateReceive"),
  // 修改订单收货地址
  UPDATE_ORDER_ADDRESS: "".concat(baseUrl, "/wxorder/updateOrderReceive"),

  /** ---------------------- 个人中心 ---------------------- **/

  // 获取订单状态
  GET_ORDER_STATUS: "".concat(baseUrl, "/wxorder/LoadOrderInfo"),
  // 获取订单列表
  GET_ORDER_LIST: "".concat(baseUrl, "/wxorder/LoadOrderList"),
  // 获取我的作品
  GET_WORKS: "".concat(baseUrl, "/wxorder/LoadMyGoods"),
  // 发送验证码
  SEND_VERIFICATION_CODE: "".concat(baseUrl, "/wx/login/code"),
  // 删除作品
  DELETE_WORKS: "".concat(baseUrl, "/wxorder/deleteGoods"),
  // 绑定手机号
  BIND_PHONE: "".concat(baseUrl, "/wx/login/information"),


  /** ---------------------- 退款维权 ---------------------- **/

  GET_ALTER_SALE: "".concat(baseUrl, "/wxorder/returnOrder") };
...
var _getters = _interopRequireDefault(__webpack_require__(/*! ./getters */ 25));



var _user = _interopRequireDefault(__webpack_require__(/*! ./modules/user */ 26));
var _category = _interopRequireDefault(__webpack_require__(/*! ./modules/category */ 28));
var _order = _interopRequireDefault(__webpack_require__(/*! ./modules/order */ 29));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //导入数据管理模块
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var getters = {
  userInfo: function userInfo(state) {return state.user;},
  categoryList: function categoryList(state) {return state.category.list;},
  orderInfo: function orderInfo(state) {return state.order.item;} };var _default =
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _mutationTypes = _interopRequireDefault(__webpack_require__(/*! ../mutationTypes */ 27));var _mutations;function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
var user = {
  ...
  _mutationTypes.default.GET_USER_INFOR, function (state, data) {
    var tempState = state;
    for (var item in tempState) {
  ...
  _mutationTypes.default.CLEAR_USER_INFO, function (state) {
    var tempState = {
      name: '',
      role: '' };
  ...
  actions: {
    ...
    data) {var commit = _ref.commit,state = _ref.state;
...
var types = {
  ...
  SET_ORDER_STATUS: 'SET_ORDER_STATUS' };var _default =
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _mutationTypes = _interopRequireDefault(__webpack_require__(/*! ../mutationTypes */ 27));
...

{
  ...
  _mutationTypes.default.SET_CATEGORY_LIST, function (state, data) {
    state.list = data;
  }),
  ...
  actions: {
    ...
    data) {var commit = _ref.commit,state = _ref.state;
      ...
      then(function (res) {
        ...
        commit(_mutationTypes.default.SET_CATEGORY_LIST, list);
      });
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 12));var _mutationTypes = _interopRequireDefault(__webpack_require__(/*! ../mutationTypes */ 27));

var _http = __webpack_require__(/*! ../../config/http.js */ 18);


var _api = __webpack_require__(/*! @/config/api.js */ 19);


var _orderStatus = __webpack_require__(/*! @/api/orderStatus */ 30);
var _runtime = _interopRequireDefault(__webpack_require__(/*! @/utils/regenerator-runtime/runtime.js */ 15));
var _filter = __webpack_require__(/*! @/config/filter.js */ 31);var _mutations;function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var _default =
...

{
  ...
  mutations: (_mutations = {}, _defineProperty(_mutations,
  _mutationTypes.default.SET_ORDER_ITEM, function (state, data) {
    state.item = data;
  }), _defineProperty(_mutations,
  _mutationTypes.default.SET_ORDER_STATUS, function (state, data) {var _loop = function _loop(
    i) {
      if (!data.find(function (item) {return item.id == i;})) data.push({
        id: i,
        title: (0, _filter.formatOrderState)(i),
        icon: (0, _filter.formatOrderStateIcon)(i),
        counts: 0 });};for (var i = 1; i < 5; i++) {_loop(i);
  ...
  actions: {
    getOrderItem: function getOrderItem(_ref,


    data) {var commit = _ref.commit,state = _ref.state;
      return (0, _orderStatus.getOrderDetail)(data).then(function (res) {
        commit(_mutationTypes.default.SET_ORDER_ITEM, res);
        return res;
      });
    },
    getOrderStatus: function () {var _getOrderStatus = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(_ref2,


      data) {var commit, state, orderStatus;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:commit = _ref2.commit, state = _ref2.state;_context.next = 3;return (
                  (0, _http.request)({
                    url: _api.GET_ORDER_STATUS,
                    showLoading: false }));case 3:orderStatus = _context.sent;

                commit(_mutationTypes.default.SET_ORDER_STATUS, orderStatus.list.map(function (item) {
                  return {
                    id: Number(item.state),
                    title: (0, _filter.formatOrderState)(item.state),
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getOrderDetail = getOrderDetail;exports.deleteOrder = deleteOrder;exports.orderDelivery = orderDelivery;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 12));var _http = __webpack_require__(/*! @/config/http.js */ 18);
...
var _util = __webpack_require__(/*! @/utils/util.js */ 32);
...
getOrderDetail(_x) {return _getOrderDetail.apply(this, arguments);}
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.formatGender = formatGender;exports.formatOrderState = formatOrderState;exports.formatOrderStateIcon = formatOrderStateIcon;exports.formatOrderButtonState = formatOrderButtonState;
/**
                                                                                                                                                                                                                                                                         * 格式化-性别
                                                                                                                                                                                                                                                                         */
...
/**
   * 格式化-订单状态icon
   */
function formatOrderStateIcon(state) {
  switch (Number(state)) {
...
/**
   * 格式化-订单按钮状态
   */
function formatOrderButtonState(state) {
  switch (Number(state)) {
    case 1:return {
        id: 1,
        name: '联系卖家',
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getList = getList;var _http = __webpack_require__(/*! @/config/http.js */ 18);
...
function getList(data) {
  ...
  return Promise.all([p_theme, p_style]).then(function (res) {
    ...
    // 样式列表中的品类ID
    var cids = Array.from(new Set(style.list.map(function (item) {return item.cid;})));
    ...
    return {
      ...
      styleList: cids.map(function (cid) {
        var item = style.list.find(function (item) {return item.cid == cid;});
        var clothesList = style.list.filter(function (item) {return item.cid == cid;});
        return {
          id: cid,
          name: item.cname,
          componentInfo: {
            ...
            clothesList: clothesList.map(function (clothes) {
              return {
                id: clothes.gid,
...
{var _ref7 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},_ref7$title = _ref7.title,title = _ref7$title === void 0 ? '删除确认' : _ref7$title,_ref7$content = _ref7.content,content = _ref7$content === void 0 ? '该数据删除后无法找回，请问是否确认删除？' : _ref7$content,_ref7$confirmText = _ref7.confirmText,confirmText = _ref7$confirmText === void 0 ? '确认' : _ref7$confirmText,_ref7$showCancel = _ref7.showCancel,showCancel = _ref7$showCancel === void 0 ? true : _ref7$showCancel,_ref7$successFunction = _ref7.successFunction,successFunction = _ref7$successFunction === void 0 ? function () {} : _ref7$successFunction,_ref7$failFunction = _ref7.failFunction,failFunction = _ref7$failFunction === void 0 ? function () {} : _ref7$failFunction;
  return new Promise(function (resolve, reject) {
    setTimeout(function () {
      wx.showModal({
        title: title,
...
{var _ref8 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},_ref8$title = _ref8.title,title = _ref8$title === void 0 ? '紧急加载中' : _ref8$title,_ref8$mask = _ref8.mask,mask = _ref8$mask === void 0 ? true : _ref8$mask,_ref8$icon = _ref8.icon,icon = _ref8$icon === void 0 ? 'loading' : _ref8$icon,_ref8$duration = _ref8.duration,duration = _ref8$duration === void 0 ? 1000 : _ref8$duration;
  return new Promise(function (resolve, reject) {
    setTimeout(function () {
      wx.showToast({
        title: title,
...
"use strict";
var _require =
__webpack_require__(/*! ../utils/storage.js */ 16),getStorage = _require.getStorage;
/**
...
module.exports = {
  ...
  AUTH_GXG_LOGO: "".concat(authUrl, "/gxglogo.png"), //授权页gxg的logo
  AUTH_ENTER_IMG: "".concat(authUrl, "/gxgenter.png"), //授权页邀请提示
  AUTH_BTN_IMG: "".concat(authUrl, "/gxgbtn.png"), //开始进入图片
  //开始定制三个按钮
  TODO_SUOFANG: "".concat(staticUrl, "/todo/suofang.png"),
  TODO_QUEDING: "".concat(staticUrl, "/todo/queding.png"),
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 12));var _http = __webpack_require__(/*! @/config/http.js */ 18);
...
var _runtime = _interopRequireDefault(__webpack_require__(/*! @/utils/regenerator-runtime/runtime.js */ 15));
var _todoDetail = __webpack_require__(/*! @/api/todoDetail.js */ 62);
...
var detail = {
  data: function data() {
    return {
      ...
      selectList: [], //选择列表内容
      isFontTouch: false,
      moveViewWidth: moveViewWidth, //画布宽
      moveViewHeight: moveViewHeight, //画布高
  ...
  (0, _vuex.mapMutations)('order', [_mutationTypes.default.SET_ORDER_ITEM]), {
    ...
    /**
                                                                                * 判断要定制的位置
                                                                                */
    judgeLocation: function judgeLocation(localIndex) {
      if (localIndex == 0) {
        this.pnIndex = 0;
    ...
    loadFontType: function () {var _loadFontType = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4() {var tempFont;return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:
                ...
                tempFont.length && tempFont.map(function (item) {
                  if (item.familyUrl) {
                    ...
                    uni.loadFontFace({
                      family: item.family,
                      source: "url(\"".concat(item.familyUrl, "\")"),
                      success: function success(res) {
                        uni.hideLoading();
                      },
                      fail: function fail(res) {
                        ...
                        console.log(res);
                        console.log("url(\"".concat(item.familyUrl, "\")"));
                      } });
    ...
    getFont: function getFont() {
      (0, _todoDetail.getFontColor)().then(function (res) {
        fontColor = res.map(function (item) {
          return {
            id: item.id,
            color: item.value };
      ...
      (0, _todoDetail.getFontFamily)().then(function (res) {
        fontFailmy = res.map(function (item) {
          return {
            id: item.id,
            name: item.name,
            url: item.fonturl };
      ...
      (0, _todoDetail.getFontSize)().then(function (res) {
        fontSize = res.map(function (item) {
          return {
            id: item.id,
            name: item.value,
            size: item.value };
    ...
    preview: function () {var _preview = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee7() {var _this2 = this;return _regenerator.default.wrap(function _callee7$(_context7) {while (1) {switch (_context7.prev = _context7.next) {case 0:if (!
                ...
                then(function (res) {
                  res.resultList.find(function (item) {return item.localtion == 'positive';}).url = _this2.clotheList.find(function (item) {return item.localtion ==
                    'positive';}).clotheImg;
                  res.resultList.find(function (item) {return item.localtion == 'negative';}).url = _this2.clotheList.find(function (item) {return item.localtion ==
                    'negative';}).clotheImg;
                  getApp().globalData.previewInfo = res;
                  uni.redirectTo({
                    url: _router.PERVIEW_DETAIL,
                    success: function success() {
    ...
    /**
                                                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                                                         */
    //选择图片
    choosedImg: function choosedImg(e) {
      var elementDetail = this.elementList[e.currentTarget.dataset.img];
      var eleWidth = parseInt(elementDetail.width);
      var eleHeight = parseInt(elementDetail.height);
      ...
      var tempElement = Object.assign({}, elementDetail, {
    ...
    //改变元素选择
    changeElment: function changeElment(e) {
      var temp = {};
      this.isTouch = false;
      this.todoIndex = this.choosedDesign.elements.length - 1;
      ...
      var angle = this.choosedDesign.elements[this.choosedDesign.elements.length - 1].angle;
      var rotate = -360;
      this.sliderValue = angle / rotate * 100 + 50;
      this.isTouch = true;
    },
    ontouchStartEvent: function ontouchStartEvent() {
      this.local = {};
    },
    //拖动过程中触发的事件
    changeLocal: function changeLocal(e) {
      e.preventDefault();
    ...
    ontouchend: function ontouchend(e) {
      ...
      if (this.todoIndex == e.currentTarget.dataset.index && this.isTouch) {
        try {
          var x = this.local.detail.x;
          var y = this.local.detail.y;
    ...
    isOverflow: function isOverflow() {
      var x = this.choosedDesign.elements[this.todoIndex].x;
      var y = this.choosedDesign.elements[this.todoIndex].y;
      var w = this.choosedDesign.elements[this.todoIndex].width;
      var h = this.choosedDesign.elements[this.todoIndex].height;
      var rotate = -(this.choosedDesign.elements[this.todoIndex].angle / 180) * Math.PI;
      var pointArr = [];
      pointArr.push((0, _util.anglePoint)({
        ox: x + w / 4,
        oy: -y - h / 4,
        ax: x,
        ay: -y,
    ...
    clickIcon: function clickIcon(e) {
      this.isTouch = false;
      var currentEle = this.choosedDesign.elements[e.currentTarget.dataset.index];
      if (e.currentTarget.dataset.id == 1) {
        ...
        //缩小
        var _scale = 0.1;
        currentEle.width = currentEle.width * (1 - _scale);
        currentEle.height = currentEle.height * (1 - _scale);
    ...
    sliderChange: function sliderChange(e) {
      var currentEle = this.navIndex ? this.choosedDesign.font[this.fontIndex] : this.choosedDesign.elements[this.todoIndex];
    ...
    touch: function touch(e) {
      ...
      var currentEle = this.choosedDesign.elements[this.todoIndex];
      var temp = currentEle.height - currentEle.width;
      var num = 0.05;
    ...
    clickFontIcon: function clickFontIcon(e) {
    ...
    // 记录移动数据
    changeFontLocal: function changeFontLocal(e) {
    ...
    //拖动字体
    ontouchfontend: function ontouchfontend(e) {
    ...
    // },
    //编辑框的宽度随着字体数量而改变
    changeFontWidth: function changeFontWidth(e) {
      var font = this.choosedDesign.font[this.fontIndex];
      var w = font.width;
      var size = font.size;
      var lengths = (0, _util.getBLen)(font.content);
      if (lengths) {
    ...
    changeFontEvent: function changeFontEvent(e) {var _this3 = this;
      this.isFontTouch = false;
      var selectIndex = e.currentTarget.dataset.iconindex;
      var keyIndex = e.currentTarget.dataset.index;
      var selectId = e.currentTarget.dataset.id;
      var pindex = e.currentTarget.dataset.pindex;
      var id = this.choosedDesign.font[pindex].id;
      var font = this.choosedDesign.font[pindex];
      var name = this.selectList[keyIndex].name;
      var url = this.selectList[keyIndex].url;
      var familyid = this.selectList[keyIndex].id;
      if (font.content) {
        this.isShowText = true;
        if (selectIndex == 0) {
          uni.showLoading({
          ...
          var size = this.selectList[keyIndex].size;
          var multiple = font.size / size;
          font.size = size;
    ...
    //点击字体进行编辑
    clickTextEvent: function clickTextEvent(e) {
      if (this.navIndex === 1) {
        this.isFontTouch = false;
        var angle = this.choosedDesign.font[e.currentTarget.dataset.index].angle;
        var rotate = -360;
        var fontObj = this.choosedDesign.font[this.choosedDesign.font.length - 1];
        if (fontObj.content) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.loadElement = loadElement;exports.getSeries = getSeries;exports.getPattern = getPattern;exports.getProductImgs = getProductImgs;exports.getFontFamily = getFontFamily;exports.getFontSize = getFontSize;exports.getFontColor = getFontColor;exports.saveDesign = saveDesign;var _http = __webpack_require__(/*! @/config/http.js */ 18);
...
//判断元素的宽高
function changeElmentArea() {var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},_ref$width = _ref.width,width = _ref$width === void 0 ? 0 : _ref$width,_ref$height = _ref.height,height = _ref$height === void 0 ? 0 : _ref$height;
  var eleWidth = parseInt(width);
  var eleHeight = parseInt(height);
...
function getCanvasRatio() {var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},_ref2$setWidth = _ref2.setWidth,setWidth = _ref2$setWidth === void 0 ? '' : _ref2$setWidth,_ref2$currentWidth = _ref2.currentWidth,currentWidth = _ref2$currentWidth === void 0 ? '' : _ref2$currentWidth;
...
/**
   * 获取元素
   */
function loadElement(data, viewWidth, viewHeight) {
  return (0, _http.request)({
    url: _api.LOAD_ELEMENT,
    data: _objectSpread({},
    data, {
  ...
  then(function (res) {
    ...
    var GoodsInfo = res.list.GoodsInfo;
    var img = res.list.img;
    var font = res.list.font;
    var isProduct = data.type == 0;
    var ratio = getCanvasRatio({
    ...
    return [{
      ...
      localtion: 'positive',
      choosedDesign: {
        elements: img.filter(function (item) {return item.location == 1;}).map(function (item) {
          if (isProduct) {
            var obj = changeElmentArea({ width: item.pwidth, height: item.pheight });
        ...
        font: font.filter(function (item) {return item.location == 1;}).map(function (item) {
...

    {
      ...
      localtion: 'negative',
      choosedDesign: {
        elements: img.filter(function (item) {return item.location == 2;}).map(function (item) {
          return {
            y: Number(item.y) / ratio,
            x: Number(item.x) / ratio,
            angle: item.angle,
        ...
        font: font.filter(function (item) {return item.location == 2;}).map(function (item) {
          item.y = Number(item.y) / ratio;
          item.x = Number(item.x) / ratio;
          return item;
        }) } }];
...
/**
   * 获取图案列表
   */
function getPattern(id, showLoading) {
  return (0, _http.request)({
    url: _api.GET_PATTERN,
    data: {
      id: id },
...
/**
   * 获取产品图片
   */
function getProductImgs() {var _ref3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},_ref3$id = _ref3.id,id = _ref3$id === void 0 ? 0 : _ref3$id,_ref3$type = _ref3.type,type = _ref3$type === void 0 ? 1 : _ref3$type;
  if (Number(type) === 2) {
    return (0, _http.request)({
      url: _api.GET_PRODUCT_IMG,
      data: {
        id: id } }).

    then(function (res) {
      return {
        zimg: res.find(function (item) {return item.type == 'zimg';}).url,
        fimg: res.find(function (item) {return item.type == 'fimg';}).url };
...
function saveDesign(data) {
  var params = {
    ...
    id: data.id,
    size: data.size,
    zimg: conversionElement(data.resultList.find(function (item) {return item.localtion == 'positive';}).choosedDesign.elements),
    zfont: conversionFont(data.resultList.find(function (item) {return item.localtion == 'positive';}).choosedDesign.font),
    fimg: conversionElement(data.resultList.find(function (item) {return item.localtion == 'negative';}).choosedDesign.elements),
    ffont: conversionFont(data.resultList.find(function (item) {return item.localtion == 'negative';}).choosedDesign.font),
    widths: data.widths,
    heights: data.heights };

  return (0, _http.request)({
    method: 'POST',
    url: _api.SAVE_DESIGN,
    showLoading: true,
    data: params }).
  then(function (res) {
    return {
      ...
      sexName: (0, _filter.formatGender)(res.info.sexName),
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.paySuccess = paySuccess;exports.getDeliveryInfor = getDeliveryInfor;exports.getAddressInfor = getAddressInfor;exports.submitOrder = submitOrder;exports.unifiedOrder = unifiedOrder;var _http = __webpack_require__(/*! @/config/http.js */ 18);
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.createOrder = createOrder;var _http = __webpack_require__(/*! @/config/http.js */ 18);
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getColtheInfo = getColtheInfo;var _http = __webpack_require__(/*! @/config/http.js */ 18);
...
function getColtheInfo(id) {
  return (0, _http.request)({
    url: _api.GET_RELEASE_BY_CATEGORY,
    showLoading: false,
    data: {
      categoryid: id } }).
  ...
  then(function (res) {
    return {
      typeId: id,
      clothesType: res.map(function (item) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.addReceiveAddress = addReceiveAddress;exports.deleteReceiveAddress = deleteReceiveAddress;exports.updateReceiveAddress = updateReceiveAddress;var _http = __webpack_require__(/*! @/config/http.js */ 18);
...
function deleteReceiveAddress(id) {
  return (0, _http.request)({
    method: 'POST',
    url: _api.DELETE_RECEIVE_ADDRESS,
    data: { receiveid: id } });
...
function updateReceiveAddress(data) {
  return (0, _http.request)({
    method: 'POST',
    url: _api.UPDATE_RECEIVE_ADDRESS,
    data: {
      receiveid: data.id,
      name: data.userName,
      phone: data.phone,
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getAlterSale = getAlterSale;var _http = __webpack_require__(/*! @/config/http.js */ 18);
...
function getAlterSale(data) {
  return (0, _http.request)({
    method: 'POST',
    url: _api.GET_ALTER_SALE,
    data: data });
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getOrderList = getOrderList;var _http = __webpack_require__(/*! @/config/http.js */ 18);
...
var _filter = __webpack_require__(/*! @/config/filter */ 31);




function getOrderList(data, showLoading) {
  var p1 = (0, _http.request)({
    url: _api.GET_ORDER_LIST,
    showLoading: showLoading,
    data: data });

  var p2 = (0, _http.request)({
    url: _api.GET_ORDER_BUTTON,
    ...
    return {
      ...
      list: res.list.map(function (item) {
        return {
          ...
          sexName: (0, _filter.formatGender)(item.sexName),
          ...
          address: item.address,
          phone: item.phone,
          status: (0, _filter.formatOrderStateIcon)(item.state),
          showBtn: result[1].list.map(function (item) {return item.id;}),
...
function getCreationList(data, showLoading) {
  return (0, _http.request)({
    url: _api.GET_WORKS,
    showLoading: showLoading,
    data: _objectSpread({},
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getReceiveAddress = getReceiveAddress;exports.updateOrderAddress = updateOrderAddress;var _http = __webpack_require__(/*! @/config/http.js */ 18);
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getTypeInfo = getTypeInfo;exports.getSizeInfo = getSizeInfo;exports.getClotheInfo = getClotheInfo;var _http = __webpack_require__(/*! @/config/http.js */ 18);
...
function removeDuplicates(array, key) {
  ...
  var keys = Array.from(new Set(array.map(function (item) {
    return item[key];
  })));
  return keys.map(function (i) {return array.find(function (j) {return j && j[key] == i;});});
}
...
function clearEmpty(arr) {
  ...
  //  })
  //  return resArr
  return arr.filter(function (item) {return !isEmpty(item);});
}

function getTypeInfo(data) {
  return (0, _http.request)({
    url: _api.GET_RELEASE_DETAIL,
    data: data }).
  then(function (res) {
    return {
      vid: res.list[0].vid,
      ...
      map(function (sexItem, sexIndex) {
        return {
          sexId: sexIndex,
          name: (0, _filter.formatGender)(sexItem.sex),
          value: sexItem.sex,
          color: removeDuplicates(res.list.filter(function (colorItem) {return colorItem.sex == sexItem.sex;}), 'color').
          map(function (colorItem, colorIndex) {
            return {
              colorId: colorIndex,
...
function getSizeInfo(data) {
  return (0, _http.request)({
    url: _api.GET_PRODUCT_SIZE,
    data: data }).
  then(function (res) {
    var changeArr = clearEmpty(sortSizeList(removeDuplicates(res.list, 'size')));
    return {
      list: changeArr.map(function (item) {
        return {
          sizeId: item.id,
          name: item.size,
          value: item.size };
...
function getClotheInfo(data) {
  var p_info = (0, _http.request)({
    url: _api.GET_PRODUCT_BY_RELEASEID_COLOR_SIZE_SEX,
    data: data });

  var p_img = (0, _http.request)({
    url: _api.GET_PRODUCT_IMG_BY_RELEASEID_COLOR_SIZE_SEX,
    data: data });

  return Promise.all([p_info, p_img]).then(function (res) {
    var info = res[0].list[0];
    var imgs = res[1].list;
    ...
    return {
      ...
      imgList: [].concat(_toConsumableArray(
      imgs.filter(function (item) {return item.type == 'zimg';})), _toConsumableArray(
      imgs.filter(function (item) {return item.type == 'fimg';})), _toConsumableArray(
      imgs.filter(function (item) {return item.type == 'qimg';}))) };
